...
declare const Prj4GroupAndroidGroup3Application_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class Prj4GroupAndroidGroup3Application extends Prj4GroupAndroidGroup3Application_base {
