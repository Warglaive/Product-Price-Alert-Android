...
public interface RestAPI {
    ...
    @POST("http://192.168.0.111:3000/users/")
    Call<UserData> postUser(@Body UserData userData);

    @GET("http://192.168.0.111:3000/products/")
    Call<List<ProductData>> getAllProducts();

    @POST("http://192.168.0.111:3000/products/")
    ...
    @GET("http://192.168.0.111:3000/users/login/{email}")
